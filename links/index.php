<?php include($_SERVER['DOCUMENT_ROOT'].'/includes/header.php'); ?>
	...
	<h3>B&uuml;cher &amp; Brosch&uuml;ren</h3>		
		<ul class="nolist">
			...
			<li><a href="http://www.amazon.de/Master-Switch-Information-Empires-Vintage/dp/0307390993"><strong>Tim Wu. 2011. The Master Switch: The Rise and Fall of Information Empires. Vintage. </strong></a></li>
		...
		<h3>Policy Paper</h3>
			<ul class="nolist">
				...
				<li><a href="http://rtr.at/nn"><strong>RTR-Positionspapier: Netzneutralit&auml;t</strong></a></li>
				<li><a href="/files/PositionspapierRTR.pdf"><strong>Stellungnahme auf das Positionspapier der RTR zur Netzneutralit&auml;t</strong></a></li>
		...
		<h3>Visualisierungen</h3>
			<ul class="nolist">
				...
				<li><a href="http://netneutralitymap.org/"><strong>Weltkarte der Netzneutralit&auml;tsverletzungen</strong></a> (basierend auf Glasnost Messdaten von M-Lab)</li>
			</ul>	

		<h3>befreundete Projekte</h3>
			<ul class="nolist">
